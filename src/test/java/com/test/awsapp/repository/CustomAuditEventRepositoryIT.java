package com.test.awsapp.repository;

import com.test.awsapp.Newapps1App;

import com.test.awsapp.config.Constants;
import com.test.awsapp.config.audit.AuditEventConverter;
import com.test.awsapp.domain.PersistentAuditEvent;
...
import static com.test.awsapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
